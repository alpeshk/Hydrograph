...
public class ExpressionComposite extends Composite {
	...
	private void createExpressionEditingTextBox(Composite composite_1) {
        ...
        GridData gd_openEditorBtn = new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1);
        gd_openEditorBtn.heightHint = 25;
        
        if(OSValidator.isMac()){
                        gd_openEditorBtn.widthHint = 43;
                        gd_openEditorBtn.horizontalIndent=-5;
                        
        }else{
                        gd_openEditorBtn.widthHint = 30;
        }
        openEditorButton.setLayoutData(gd_openEditorBtn);
